...
def setup_environment(config):
    ...
    if os.path.isfile("setup_pooling.py"):
        os.system("pip install -v --no-cache-dir ./install/apex/")
        os.system("python setup_pooling.py develop")
...
def main():
    ...
    from training.train_ucn import train
    train(convert_to_object(config))
