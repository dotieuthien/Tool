...
from rules.component_wrapper import get_component_color
from rules.component_wrapper import resize_mask_and_fix_components, build_neighbor_graph
from loader.features_utils import get_moment_features
from models.shallow_net import UNet
...
def extract_features(sketch, mean, std, size, y_bound, x_bound):
    ...
    mask = resize_mask_and_fix_components(mask, components, size).astype(np.int32)
