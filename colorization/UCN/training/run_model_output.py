...
def get_input_data(path, size, reference=True):
    ...
    if reference:
        ...
        return sketch, mask, components, color_image
    ...
    return sketch, mask, components, color_image, frame
...
def main(args):
    ...
    for character_dir in character_dirs:
        ...
        for index, path in enumerate(paths):
            ...
            # Get data
            sketch_a, mask_a, components_a, color_a = get_input_data(
                reference_path, image_size, reference=True)
            sketch_b, mask_b, components_b, color_b, frame = get_input_data(
