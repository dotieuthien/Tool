...
class ClosingModel:
    ...
    def process(self, tgt_sketch_im, ref_color_im=None):
        ...
        direction_dct = find_direction_v2(thinned_im, rows, cols, theta)
        ...
        for row, col in zip(chosen_rows, chosen_cols):
            ...
            dest_row, dest_col = connect_keypoint_to_boundary(
                point1=(row, col), cv2_im=thinned_im.copy(),
        ...
        ktbd = self.keypoint_to_boundary_distance
        return pair_points, unset_points, self.max_traveled_pixel, self.max_pair_distance, ktbd
